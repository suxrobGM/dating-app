    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_user_interests", x => new { x.InterestsId, x.UsersId });
                    table.ForeignKey(
                        name: "FK_user_interests_interests_InterestsId",
                        column: x => x.InterestsId,
                        principalTable: "interests",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_user_interests_users_UsersId",
                        column: x => x.UsersId,
                        principalTable: "users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_user_likes", x => new { x.LikedUsersId, x.UsersId });
                    table.ForeignKey(
                        name: "FK_user_likes_likes_LikedUsersId",
                        column: x => x.LikedUsersId,
                        principalTable: "likes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_user_likes_users_UsersId",
                        column: x => x.UsersId,
                        principalTable: "users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_profile_photos_PhotoId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_profile_photos_ProfileId",
                table: "profile_photos",
                column: "ProfileId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_user_interests_UsersId",
                table: "user_interests",
                column: "UsersId");

            migrationBuilder.CreateIndex(
                name: "IX_user_likes_UsersId",
                table: "user_likes",
                column: "UsersId");
